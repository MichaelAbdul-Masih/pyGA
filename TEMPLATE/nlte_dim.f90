...
!  DIMENSIONS FROM FILE  A10HHeCnewNOSi.dat              
 
 
!    NUMBER OF ATOMS
INTEGER(I4B), PARAMETER :: ID_ATOMS =  6
 
!    NUMBER OF FREQUENCIES (coarse mesh, modify in case)
INTEGER(I4B), PARAMETER :: ID_FREC1 =  2700
...
!    NUMBER OF IONS
INTEGER(I4B), PARAMETER :: ID_IONES =  24
 
!    NUMBER OF L + K LEVELS
INTEGER(I4B), PARAMETER :: ID_LLEVS =   751
 
!    NUMBER OF X LEVELS 
INTEGER(I4B), PARAMETER :: ID_XLEVS =     1
 
!    NUMBER OF S LEVELS
INTEGER(I4B), PARAMETER :: ID_SLEVS =    17
 
!    NUMBER OF RBB + CBB TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RCBBT = 21879
 
!    NUMBER OF RBX + CBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RCBXT =     1
 
!    NUMBER OF CBS + CBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_CBSFT =   793
 
!    NUMBER OF RBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RBFTR =   762
 
!    NUMBER OF RFF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RFFTR =    15
 
!    NUMBER OF TOTAL TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTRAN = 23449
 
!   NUMBER OF RBB + RBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTTRD =  5533
 
!    NUMBER OF DATA
INTEGER(I4B), PARAMETER :: ID_NDATA = 77865
...
INTEGER(I4B), PARAMETER :: ID_DEPFI = 5000
