...
!  
!version 7.5.6 Jan 2024:    no_check included in the same spirit as in v11:
!                           no check of thermalization after hydro_update
!                           precision of fjk-test changed (for gfortran),
!                           from 1.d-13 to 1.d-10 (needs to be tested) 
!
character*10 :: ver_nlte_app='7.5.6' 
...
&                   xnelte,alo,opac,metals_converged,lwion1,no_check
...
if(.not.no_check) then
  ...
  print*,'no check of thermalization, since just after photospheric update'
  print*
endif    
...
!JO Jan 2024: precision changed for gfortran 
         if(abs(1.-fjk(k,j,js)/fjkold).gt.1.d-10) then
