...
readmod,cat+'/OUT_TOT',' ',a
if not keyword_set(comp) then begin
  plfcl,a,/plv
endif else begin
  readmod,cat1+'/OUT_TOT',' ',b
  plfcl,a,/plv,comp=b
endelse  
endif  
