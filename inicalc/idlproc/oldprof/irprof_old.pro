pro irprof,cat,star,ps=ps,vsini=vrot1,vrad=vrad,resol=resol1, $
	    comp=comp,obscomp=obscomp,oldnames=oldnames
...
print,cat
rindat,cat,teff
if teff gt 35000. then brgamma='/OUT.BRGAMMA1' $
                  else brgamma='/OUT.BRGAMMA'
...
rindat,cat1,teff1
if teff1 gt 35000. then brgamma1='/OUT.BRGAMMA1' $
                   else brgamma1='/OUT.BRGAMMA'
