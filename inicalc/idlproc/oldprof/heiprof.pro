pro heiprof,cat,star,ps=ps,vsini=vrot1,vrad=vrad,resol=resol1,vmacro=vmacro, $
...
!x.range=[4010.,4040.]
if keyword_set(obscomp) then begin
halpha,cat+'/OUT.HEI4026'+extension,vsini=vrot,resol=resol,vmacro=vmacro, $
	compmin=min(y1), $
...
!x.range=[4380.,4395.]
if keyword_set(obscomp) then begin
halpha,cat+'/OUT.HEI4387'+extension,vsini=vrot,resol=resol,vmacro=vmacro, $
	compmin=min(y2), $
...
!x.range=[4460.,4480.]
if keyword_set(obscomp) then begin
halpha,cat+'/OUT.HEI4471'+extension,vsini=vrot,resol=resol,vmacro=vmacro, $
	compmin=min(y3), $
...
!x.range=[4915.,4930.]
if keyword_set(obscomp) then begin
halpha,cat+'/OUT.HEI4922'+extension,vsini=vrot,resol=resol,vmacro=vmacro, $
	compmin=min(y4), $
...
!x.range=[4705.,4720.]
if keyword_set(obscomp) then begin
halpha,cat+'/OUT.HEI4713'+extension,vsini=vrot,resol=resol,vmacro=vmacro, $
	compmin=min(y5), $
...
!x.range=[6670.,6685.]
if keyword_set(obscomp) then begin
halpha,cat+'/OUT.HEI6678'+extension,vsini=vrot,resol=resol,vmacro=vmacro, $
	compmin=min(y6), $
