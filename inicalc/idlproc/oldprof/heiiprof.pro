pro heiiprof,cat,star,ps=ps,vsini=vrot1,vrad=vrad,resol=resol1,vmacro=vmacro, $
...
if keyword_set(obscomp) then begin
halpha,cat+'/OUT.HEII6406'+extension,vsini=vrot,resol=resol,vmacro=vmacro, $
	compmin=min(y4), $
...
if keyword_set(obscomp) then begin
halpha,cat+'/OUT.HEII6527'+extension,vsini=vrot,resol=resol,vmacro=vmacro, $
	compmin=min(y5), $
...
if keyword_set(obscomp) then begin
halpha,cat+'/OUT.HEII6683'+extension,vsini=vrot,resol=resol,vmacro=vmacro, $
	compmin=min(y6), $
