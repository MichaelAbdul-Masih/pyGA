pro tvellipse, rmax, rmin, xc, yc, pos_ang, color, DATA = data, THICK = thick, $
	NPOINTS = npoints, COLOR = thecolor, LINESTYLE = linestyle,$
        xprime=xprime,yprime=yprime,_extra=_extra
;+
; NAME:
;	TVELLIPSE
;
...
;	xprime and yprime can be returned through keywords S.Oliver May 1997
;-
 ...
 plots, xprime, yprime, /DEVICE, COLOR=color, THICK=thick, LINESTYLE=linestyle,_extra=_extra
