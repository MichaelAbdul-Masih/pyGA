...
PRO ICPLOT, im, head, min=min, max=max, respen=respen, _extra=extra, noscale=noscale,full=full,silent=silent, axes=axes, fitspixels=fitspixels
...
;       15 Sep 1999     added /axes keyword for plotting pixel position
;                       axes, and added /fitspixels keyword (S. Serjeant)
...
if ( n_params() lt 1 ) then begin
   print, 'Usage: icplot, im [,head ,min= ,max= ,respen= ,/axes, $'
...
if(n_elements(head) eq 0 and keyword_set(axes)) then begin
