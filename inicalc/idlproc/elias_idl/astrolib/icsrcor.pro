PRO icsrcor,x1in,y1in,x2in,y2in,dcr,ind1,ind2,option=option,magnitude=magnitude,$
   spherical=spherical
;+
; NAME:
;       SRCOR
...
IF (n_params(0) lt 7) THEN BEGIN
  print,'ICSRCOR calling sequence: '
  print,'icsrcor,x1in,y1in,x2in,y2in,dcr,ind1,ind2 [,option={0, 1, or 2}] $'
